...
//Registers
pub const UNW_TDEP_IP: aarch64_regnum_t = 14;
pub const UNW_TDEP_SP: aarch64_regnum_t = 13;
pub const UNW_TDEP_EH: aarch64_regnum_t = 0;
...
extern "C" {
    ...
    #[link_name = "_Uaarch64_get_proc_info_by_ip"]
    ...
    #[link_name = "_Uaarch64_handle_signal_frame"]
